...
public class T06_ListSortTest {
	...
	public static void main(String[] args) {
		 ...
		 *     정렬 기준을 별도로 구현하고 싶을 때에는 Comparator를 구현하여 사용하면 된다.
		 *  
...
/*
 *  정렬방식을 결정하는 class는 Comparator라는 인터페이스를
 *  구현해야 한다. 이 Comparator 인터페이스의 compare()라는 메서드를 재정의하여
 *  구현하면 된다.
 */
class Desc implements Comparator<String> {
	...
	public int compare(String str1, String str2) {
		...
		// 내림차순을 하려면 -1을 곱해주면 된다.
		// 혹은 str2.compareTo(str1)을 리턴해주어도 된다.
