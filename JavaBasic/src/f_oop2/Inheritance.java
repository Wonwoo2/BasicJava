...
public class Inheritance {
	...
	public static void main(String[] args) {
		 ...
		 *  - 자식클래스에 extends 부모클래스명 { }
		 *  - 부모 클래스의 생성자와 초키화블럭을 제외한 모든 멤버를 물려받는다
		 *  - 하나의 클래스만 상속받을 수 있다
		 *  - 상속받지 않는 모든 클래스는 Object 클래스를 상속받는다.
		 *  - 자식 클래스는 부모 클래스의 멤버와의 새로운 멤버를 가질 수 있으므로 자식 클래스는 
		 *    부모 클래스보다 크거나 같다
		 ...
		 *  - 상속받은 메서드의 리턴타입, 메서드명, 파라미터가 같아야 한다
