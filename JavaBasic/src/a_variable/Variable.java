...
public class Variable {
	...
	public static void main(String[] args) {
		/*
		 * 변수 - 하나의 데이터를 저장할 수 있는 메모리상의 공간 - 타입(데이터의 종류)과 변수명(변수의이름)으로 변수를 만들 수
		 * 있다.
		 * 
		 * 사용 가능한 기본형 데이터의 종류 - 정수 : byte(1byte), short(2byte), int(4byte),
		 * long(8byte) - 실수 : float(4byte), double(8byte) - 문자 : char(2byte) -
		 * 논리 : boolean(1byte)
		 * 
		 * 명명 규칙 - 블럭안에서 변수명은 중복될 수 없다. 
		 * - 영문자 대소문자, 한글, 숫자, 특수문자('_','$')를 사용할 수 있다.(한글 사용은 자제) 
		 * - 대소문자가 구분되며 길이에 제한이 없다. 
		 * - 숫자로 시작할 수 없다. 
		 * - 예약어는 사용할 수없다. 
		 * - [기본적으로 변수는 소문자를 사용하고, 상수는 대문자를 사용한다.] 
		 * - [여러 단어로 이우어진 경우 단어의 첫
		 * 글자를 대문자로 한다.(상수는 언더바로 구분)] - [클래스명의 첫글자는 대문자로 한다.] - [패키지명은 모두 소문자로
		 * 한다.]
		 */
		...
		// =(대입연산자) : 대입 연산자 오른쪽의 값을 왼쪽(변수)에 저장한다.(오른쪽먼저 연산)
		...
		// 문자열 : ""(큰따옴표)로 감싸진 글자
		String _String = new String("app");
		System.out.println(_String);
		_String = "1234";
		System.out.println(_String);
		/*
		 * 리터럴의 종류 - 숫자 : 0,10,-5,3.14 - 문자 : '가','a','0','' - 문자열 :
		 * "가나다","abc","123" - 그외 : true, false, null
		 * 
		 * 참조형 타입 - 기본형 타입을 제외한 모든 데이터 타입(배열,클래스) - ex) String, Variable, int[]
		 * - 값이 변수에 저장되지 않고 따로 저장되며, 그 주소가 변수에 저장된다. - 변수의 크기는 4byte이다
		 */
		...
		/*
		 * 상수 - 값을 한번 저장하면 변경할 수 없는 저장공간 - final int MAX_NUMBER; - 리터럴에 의미를 부여하기
		 * 위해 사용한다.
		 */
