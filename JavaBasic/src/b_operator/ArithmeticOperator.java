...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		...
		double d = 10 + 20.3; //int + double -> double + double
		...
		// int g1 = 10/ 0; 런타임 에러 발생 (정수는 0으로 나눌 수 없음)
		float g2 = 10.0f / 0;
		System.out.println(g2); // Infinity 라는 값이 출력됨
		...
		// 산술 연산자와 대입 연산자를 합해 연산식을 줄여서 표현할 수 있다. (복합연산자)
		int i = 0;
		...
		// 반올림
		double round = 50.65;
		System.out.println(Math.round(round)); // Math 클래스의 round 메서드는 소수점 첫째 자리에서 반올림
		...
		// 1.
		long one = 123456 + 654321;
		System.out.println(one);
		// 2.
		long two = one * 123456;
		System.out.println(two);
		// 3.		
		long three = two / 123456;
		System.out.println(three);
		// 4.
		long four = three - 654321;
		System.out.println(four);
		// 5.
		long five = four % 123456;
