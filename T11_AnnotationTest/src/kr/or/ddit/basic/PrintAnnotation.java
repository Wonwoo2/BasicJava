 ...
 *  Annotation
 *  
 *  - 프로그램 소스코드 안에 다른 프로그램을 위한 정보를 미리 약속된 형식으로 표함시킨것.(JDK1.5부터 지원)
...
@Retention(RetentionPolicy.RUNTIME)		// annotation이 유지되는 기간지정함(SOURCE, CLASS, RUNTIME)
public @interface PrintAnnotation {
	int id = 100;		// 상수 선언가능, static final id = 100;
