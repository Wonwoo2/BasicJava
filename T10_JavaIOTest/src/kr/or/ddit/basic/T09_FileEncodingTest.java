...
public class T09_FileEncodingTest {
	 ...
	 *    마이크로소프트에서 EUC-KR방식에서 확장하였기 때문에 MS949라고도 부른다.
	 ...
	 *  	  => 윈도우계열 : CP949(확장완성형)
	 *  	  => 유닉스계열 : EUC-KR(확장 유닉스 코드) => (윈도우 + 유닉스계열)ANSI 계열
	 *  									  => 유니코드(UTF-8)
	 *  
	 *  	유니코드 (Unicode)
	 *  	- 서로 다른 문자 인코딩을 사용하는 컨퓨터 간의 문서교환에 어려움을 겪게 되고, 이런 문제점을 해결하기 위해 
	 *  	    전세계의 모든 문자를 하나의 통일된 문자집합(CharSet)으로 표현함.
	 *  	    처음엔 2byte(65536)으로 표현했지만, 부족해지니 21bit(약 200만 문자)로 확장되었다. => 보충문자
	 */
	public static void main(String[] args) {
		// 파일 인코딩을 이용하여 읽어오기
		// InputStreamReader스트림 => 바이트기반 스트림을 문자기반 스트림으로변환해 주는 보조 스트림
