...
public class T22_BarChartTest extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		ser1.setName("2015년");
		ser1.getData().add(new XYChart.Data<>("호주", 26000));
		ser1.getData().add(new XYChart.Data<>("브라질", 20000));
		ser1.getData().add(new XYChart.Data<>("프랑스", 10000));
		ser1.getData().add(new XYChart.Data<>("이탈리아", 35000));
		ser1.getData().add(new XYChart.Data<>("미국", 15000));
		...
		ser3.getData().add(new XYChart.Data<>("프랑스", 10000));
