...
public class T07_AnchorPaneTest extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		TextField txtFiled1 = new TextField();
		txtFiled1.setLayoutX(132);
		txtFiled1.setLayoutY(18);
		
		TextField txtFiled2 = new TextField();
		txtFiled2.setLayoutX(132);
		txtFiled2.setLayoutY(64);
		...
		root.getChildren().addAll(label1, label2, txtFiled1, txtFiled2,
									btn1, btn2);
