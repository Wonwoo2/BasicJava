...
public class T09_AlertTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		prompt.setHeaderText("TextDialog창입니다.");		// 출력 메시지
