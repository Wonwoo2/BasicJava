...
public class T11_ComboBoxTest extends Application {
	@Override
	public void start(Stage primaryStage) throws Exception {
		...
		ObservableList<MyFriend> list = FXCollections.observableArrayList(
				...
				new MyFriend("a002", "성춘향", "010-2222-2222", "서울"),
				new MyFriend("a003", "강감찬", "010-3333-3333", "광주"),
				new MyFriend("a004", "일지매", "010-4444-4444", "울산"),
				new MyFriend("a005", "이순신", "010-5555-5555", "포항"),
				new MyFriend("a006", "변학도", "010-6666-6666", "부산")
		);
