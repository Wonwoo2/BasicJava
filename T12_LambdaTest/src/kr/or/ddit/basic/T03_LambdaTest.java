...
public class T03_LambdaTest {
	public static void main(String[] args) {
		// 람다식을 사용하지 않았을 경우
		T02_LambdaInterfaceTest lam1 = new T02_LambdaInterfaceTest() {
			@Override
			public void test() {
		...
		T02_LambdaInterfaceTest2 lam8 =
				(x, y) -> x + y;
				
		k = lam8.test(100, 200);
		System.out.println("k = " + k);
		
		T02_LambdaInterfaceTest2 lam9 =
				(x, y) -> { return x > y ? x : y;};
